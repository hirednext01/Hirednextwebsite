...
class Seo extends BaseController
{
    ...
    public function llms()
    {
        ...
        $lines = [
            ...
            '- [Best CV & Resume Writing Service India Guide](' . base_url('guides/best-cv-writing-service-india') . '): Answers who can professionally write or rebuild a CV/resume in India, how to compare providers, and where HiredNext fits without self-awarding a number-one ranking.',
