            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                <div class="reveal reveal-right">
                    ...
                    <p class="text-lg md:text-xl text-white/80 mb-10 max-w-2xl leading-relaxed">
                        Retained executive search and leadership hiring for CXO and mid-senior roles in India, with
                        sector-aligned recruiters across IT, BFSI, Retail, Engineering, and Manufacturing.
                    </p>
