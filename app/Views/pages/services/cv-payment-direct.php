    ...
    <div class="max-w-[820px] mx-auto px-4 sm:px-8">
        <div class="bg-white rounded-[2rem] border border-gray-200 p-8 md:p-12 shadow-sm">
            <div class="text-center mb-8">
                ...
                <p class="text-gray-600">Use the verified HiredNext UPI QR or bank transfer details below. Check that the beneficiary shown by your payment or bank app is HIREDNEXT, never an individual's name or phone number.</p>
            </div>
