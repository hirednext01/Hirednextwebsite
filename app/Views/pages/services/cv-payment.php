            ...
            <div class="grid md:grid-cols-2 gap-8 items-center">
                <div>
                    ...
                    <div class="rounded-2xl border border-gray-200 bg-white p-5 text-sm text-gray-700">
                        <div class="font-bold text-primary mb-1">HiredNext verified payment QR</div>
                        <div>Scan with Paytm, Google Pay, PhonePe or another UPI app.</div>
                        <div class="mt-2 text-xs text-gray-500">The phone-linked UPI ID is intentionally not printed on this page.</div>
                    </div>
                </div>
                <div class="flex flex-col items-center justify-center">
                    <div class="bg-white p-3 rounded-2xl border border-gray-200 shadow-sm">
                        <img src="<?= base_url('theme/assets/hirednext-paytm-qr.jpg') ?>?v=2" alt="HiredNext UPI QR code for ₹599 priority CV assessment" width="320" height="320" class="block w-full max-w-[320px] h-auto rounded-xl" loading="eager">
                    </div>
