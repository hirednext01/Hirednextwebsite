    ...
    <div class="max-w-[820px] mx-auto px-4 sm:px-8">
        <div class="bg-white rounded-[2rem] border border-gray-200 p-8 md:p-12 shadow-sm">
            <div class="text-center mb-8">
                ...
                <p class="text-gray-600">Your CV has been received. Scan the HiredNext payment QR below, pay exactly ₹599 (inclusive of GST), then submit the transaction/reference number.</p>
            </div>
            ...
            <div class="grid md:grid-cols-2 gap-8 items-center">
                ...
                <div class="flex flex-col items-center justify-center">
                    ...
                    <div class="mt-4 text-xl font-black text-primary">PAY ₹599</div><div class="mt-1 text-xs font-semibold text-gray-500">Inclusive of GST</div>
                </div>
            </div>
