...
$cvQuestions = [
    ...
    ['What is the difference between CV making, CV writing, CV remake and CV rebuild?', 'In the Indian market these phrases are often used for overlapping services. At HiredNext, CV rebuild means a managed rewrite and restructure based on your verified experience. CV assessment is the diagnosis step; the ₹1,799 rebuild includes that assessment plus two finished CV variants and two revision rounds.'],
