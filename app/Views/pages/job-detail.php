        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-start">
            ...
            <aside class="lg:col-span-4 space-y-5 lg:sticky lg:top-24">
                ...
                <div class="overflow-hidden rounded-2xl border border-orange-200 bg-white shadow-sm">
                    ...
                    <div class="mt-5 grid gap-2"><a href="<?= base_url('services/cv-assessment?job=' . rawurlencode((string) ($job['slug'] ?? '')) . '&utm_source=job_detail&utm_medium=website&utm_campaign=cv_readiness') ?>" class="rounded-xl bg-accent px-4 py-3 text-center text-sm font-black text-white">Assess my CV — ₹992 + GST</a><a href="<?= base_url('career-services/start/rebuild_2500') ?>" class="rounded-xl border border-primary/20 px-4 py-3 text-center text-sm font-black text-primary">Get my CV rebuilt — ₹2,500 + GST</a></div></div>
                </div>
