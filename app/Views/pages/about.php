    ...
    <div class="max-w-[1180px] mx-auto px-4 sm:px-8">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            ...
            <?php foreach ($steps as $step): ?>
                <article class="rounded-2xl border border-gray-200 p-7 bg-white hover:shadow-md transition-shadow"><div class="text-accent text-sm font-black mb-4"><?= esc($step[0]) ?></div><h3 class="text-xl font-bold text-primary mb-3"><?= esc($step[1]) ?></h3><p class="text-sm text-gray-600 leading-relaxed"><?= esc($step[2]) ?></p></article>
            <?php endforeach; ?>
        </div>
    </div>
</section>
