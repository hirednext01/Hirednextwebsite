...
$routes->get('admin/cv-studio/(:num)/documents/(:num)/word', 'CvStudioAdmin::downloadWord/$1/$2');
$routes->post('admin/cv-studio/(:num)/documents/(:num)/deliver', 'CvStudioAdmin::deliver/$1/$2');
