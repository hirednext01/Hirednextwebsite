...
$routes->group('api', ['namespace' => 'App\\Controllers\\Api'], function ($routes) {
    ...
    $routes->put('users/(:num)', 'UsersApi::update/$1');
    $routes->delete('users/(:num)', 'UsersApi::delete/$1');
    $routes->put('users/(:num)/status', 'UsersApi::changeStatus/$1');
    $routes->post('users/(:num)/change-password', 'UsersApi::changePassword/$1');
    ...
    $routes->put('contact-messages/(:num)/read', 'ContactMessagesApi::markAsRead/$1');
    $routes->put('contact-messages/(:num)/replied', 'ContactMessagesApi::markAsReplied/$1');
    ...
    $routes->get('jobs/(:num)', 'JobsApi::show/$1');
    $routes->put('jobs/(:num)', 'JobsApi::update/$1');
    ...
    $routes->put('press-media/(:num)', 'PressMediaApi::update/$1');
    $routes->delete('press-media/(:num)', 'PressMediaApi::delete/$1');
});
