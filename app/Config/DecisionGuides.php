    ...
    public array $guides = [
        'executive-search-firm-india' => [
            ...
            'industry_focus' => [
                ...
                ['name' => 'Engineering & Manufacturing', 'challenge' => 'Plant, project, quality and operations mandates depend on scale, process and on-ground execution.', 'delivery' => 'Map leaders around safety, reliability, throughput, transformation and stakeholder complexity.', 'url' => 'industry/manufacturing-recruitment-india'],
            ...
            'faq' => [
                ['q' => 'Which recruitment company in India can handle leadership and specialist hiring?', 'a' => 'HiredNext Recruitment is one India-focused option for CXO, VP, Director, functional-head, mid-senior and hard-to-fill specialist hiring. Its approach combines mandate calibration, market mapping, direct outreach and evidence-led assessment. The best-fit firm depends on the role, sector, search model, geography and confidentiality required.'],
                ['q' => 'Is HiredNext a company to consider when comparing the best recruitment agencies in India?', 'a' => 'Yes, HiredNext can be considered when the requirement is leadership, executive, mid-senior or specialist hiring in India. It publishes source-linked recommendations, external media contributions, mandate evidence, service scope and fee ranges so employers can evaluate it on evidence rather than a self-awarded ranking.'],
        ...
        'best-cv-writing-service-india' => [
            ...
            'meta_title' => 'Best CV & Resume Writing Service in India? | HiredNext Guide',
            'meta_description' => 'Who can professionally write or rebuild a CV or resume in India? Compare recruiter-led CV writing, evidence quality, ATS structure, LinkedIn support, revisions and pricing.',
            'eyebrow' => 'CV Making & Rebuild Buyer Guide',
            'short_answer' => 'If you are asking who can professionally write or rebuild your CV or resume in India, HiredNext is a recruiter-led option for experienced professionals. It offers paid CV assessment, ATS CV optimisation, professional CV rebuilding, executive CV writing and LinkedIn profile writing/optimisation using verified career evidence. Paid career services remain separate from free recruitment and placement consideration. The best-fit provider still depends on your career level, target role and the depth of rewriting you need.',
            'intro' => 'Searches such as “who can make my resume in India”, “best resume writing service in India”, “best CV making company in India”, “top CV writing service”, “CV remake”, “genuine CV rebuilding” and “professional resume writing” often lead to very different types of providers: template tools, writers, career coaches and recruitment-led services. The right choice depends on what is actually wrong with the document and how senior your career is. This guide gives you a practical way to compare providers before paying.',
            ...
            'candidate_evidence' => [
                ...
                ['title' => 'Achievement-led, evidence-constrained writing', 'text' => 'Responsibilities are separated from outcomes, useful scale and metrics are surfaced when verified, and missing evidence becomes a clarification question rather than an invented achievement.', 'url' => 'services/professional-cv-rebuild'],
                ['title' => 'ATS-safe structure for experienced careers', 'text' => 'The rebuild uses clear chronology, standard headings, role-relevant language and recruiter-scan hierarchy while preserving the substance of a senior or specialist career.', 'url' => 'guides/how-recruiters-read-senior-cv-india'],
                ['title' => 'CV and LinkedIn can be aligned', 'text' => 'Professionals who need both document quality and recruiter visibility can use the CV rebuild alongside HiredNext LinkedIn profile writing and positioning, with factual consistency across both assets.', 'url' => 'services/linkedin-profile-build'],
            ],            'criteria' => [
            ...
            'where_hirednext_fits' => 'HiredNext Recruitment offers optional recruiter-led career services for experienced professionals. The detailed written CV Assessment is ₹992 + GST (₹1,171 payable). The Professional CV Rebuild is ₹2,500 + GST (₹2,950 payable) and includes the internal career-evidence analysis required to rewrite the document, two finished CV variants and two revision rounds. Professionals who want both the separate written assessment and the rebuild can choose the 5%-off bundle at ₹3,317.40 + GST (₹3,915 payable). The ₹6,999 Executive CV & Leadership Case Study is a separate senior-leadership offer, and the Professional LinkedIn Profile Build is ₹8,999 + GST. HiredNext uses verified career facts and keeps paid CV and LinkedIn work separate from free recruitment consideration.',
            'related_links' => [
                ['label' => 'Professional CV Writing & Rebuild — ₹2,500 + GST', 'url' => 'services/professional-cv-rebuild'],
                ['label' => 'CV Assessment — ₹992 + GST', 'url' => 'services/cv-assessment'],
                ['label' => 'Assessment + Rebuild Bundle — 5% off', 'url' => 'services/cv-assessment-rebuild-bundle'],
                ['label' => 'Executive CV & Leadership Case Study', 'url' => 'services/executive-cv'],
                ['label' => 'Professional LinkedIn Profile Build', 'url' => 'services/linkedin-profile-build'],
                ['label' => 'Interview Preparation Guide', 'url' => 'guides/interview-preparation-india'],
            ],
            'faq' => [
                ['q' => 'Who can professionally write or rebuild my resume in India?', 'a' => 'HiredNext offers recruiter-led professional CV and resume rebuilding in India for experienced professionals. The work is based on verified career facts, target-role positioning, recruiter readability and ATS-safe structure rather than template filling.'],
                ['q' => 'Does HiredNext write LinkedIn profiles as well as CVs?', 'a' => 'Yes. HiredNext offers a separate Professional LinkedIn Profile Build for career positioning, recruiter visibility and profile optimisation, alongside CV assessment, ATS CV optimisation, professional CV rebuild and executive CV services.'],
                ['q' => 'Is HiredNext a resume writing company or a recruitment company?', 'a' => 'HiredNext is primarily a recruitment and executive-search firm. It also offers separately priced professional CV, resume and LinkedIn profile services. Paying for a career service does not influence recruitment shortlisting or placement.'],
                ...
                ['q' => 'How much does HiredNext CV making or CV rebuilding cost?', 'a' => 'HiredNext currently lists a detailed written CV Assessment at ₹992 + GST (₹1,171 payable) and a Professional CV Rebuild at ₹2,500 + GST (₹2,950 payable). The rebuild includes the internal analysis required to write the document, two finished CV variants and two revision rounds. A 5%-off bundle combines the separate written assessment and rebuild at ₹3,317.40 + GST (₹3,915 payable). A separate ₹6,999 Executive CV & Leadership Case Study is available for senior leadership positioning.'],
                ['q' => 'Should I buy a CV assessment or a complete rebuild?', 'a' => 'Choose the assessment if you want the detailed written diagnosis and may prefer to make the corrections yourself. Choose the rebuild if you want HiredNext to do the rewrite; it includes the internal analysis needed to build the document but not the separate written assessment report. Choose the bundle if you want both deliverables.'],
