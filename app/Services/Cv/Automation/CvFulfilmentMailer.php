...
class CvFulfilmentMailer
{
    public function deliver(array $order,string $path,string $deliveryId): array
    {
        ...
        $email->setMessage($body); $email->attach($path,'attachment',$deliveryId.'.pdf','application/pdf');
        ...
        return ['accepted'=>true,'message_id'=>$messageId?:null,'delivery_id'=>$deliveryId,'email_event_id'=>$event,'smtp_accepted_at'=>gmdate('c')];
    }
}
